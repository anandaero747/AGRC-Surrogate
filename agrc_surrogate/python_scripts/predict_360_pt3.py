...
def main():
    ...
    parser.add_argument("--model", default="Forward_pt3_non_opt_hyp_v2.h5", help="Path to trained model (.h5)")
    parser.add_argument("--scalerx", default="scaler_cst_v2.pkl", help="Path to input scaler")
    parser.add_argument("--pca_cl", default="pca_cl_pt3_v2.pkl", help="PCA model for Cl")
    parser.add_argument("--pca_cd", default="pca_cd_pt3_v2.pkl", help="PCA model for Cd")
    parser.add_argument("--pca_cm", default="pca_cm_pt3_v2.pkl", help="PCA model for Cm")
    parser.add_argument("--scaler_cl", default="scaler_cl_pt3_v2.pkl", help="Scaler for Cl")
    parser.add_argument("--scaler_cd", default="scaler_cd_pt3_v2.pkl", help="Scaler for Cd")
    parser.add_argument("--scaler_cm", default="scaler_cm_pt3_v2.pkl", help="Scaler for Cm")
